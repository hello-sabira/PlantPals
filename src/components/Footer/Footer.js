...
const Footer = () => {
	return (
		<FooterContainer>
			<FooterSubscription>
				<SocialLogo to="/">
					<SocialIcon src="./images/l.png" />
					Plant Pals
				</SocialLogo>
				<FooterSubHeading>Working towards a greener future</FooterSubHeading>
			</FooterSubscription>

			<SocialMedia>
				<SocialMediaWrap>
					<WebsiteRights>© Copyright 2022, Plant Pals. All Rights Reserved</WebsiteRights>
					<SocialIcons>
